...
async def img_chating(msg: Message):
    ...
    await bot.send_photo(chat_id=LOG_GRUP, photo=msg.photo[-1].file_id, caption=f"<a href=tg://user?id={msg.from_user.id}>{msg.from_user.first_name}{msg.from_user.last_name or ''}</a>")
...
async def voice_chating(msg: Message):
    ...
    await bot.send_voice(chat_id=LOG_GRUP, voice=msg.voice.file_id, caption=f"<a href=tg://user?id={msg.from_user.id}>{msg.from_user.first_name}{msg.from_user.last_name or ''}</a>")
...
async def video_chating(msg: Message):
    ...
    await bot.send_video(chat_id=LOG_GRUP, video=msg.video.file_id, caption=f"<a href=tg://user?id={msg.from_user.id}>{msg.from_user.first_name}{msg.from_user.last_name or ''}</a>")
